...
def _get_os_arch(ldap_conn, config_dict):
    ...
    for dn, attrs in ldap_conn.search_s(base="o=glue",
        ...
        EL9_CES = ["heplnx208.pp.rl.ac.uk", "heplnx207.pp.rl.ac.uk", "arcce02.esc.qmul.ac.uk",  "t2arc01.physics.ox.ac.uk", "ce02.gla.scotgrid.ac.uk", "ce2.gridpp.ecdf.ed.ac.uk"]
